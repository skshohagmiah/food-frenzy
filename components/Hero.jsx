  ...
  return (
    <div className='flex p-2  min-h-full flex-col-reverse md:gap-4 md:flex-row items-center justify-between'>
        <div className='flex flex-2 flex-col gap-8 text-center md:text-left'>
            <h1 className='text-4xl md:text-6xl md:leading-[5rem] font-bold '>Your One-Stop Shop for <br /> <span className='text-orange-600 italic'>Delicious Food</span></h1>
            ...
            <div className='flex items-center gap-4 justify-center md:justify-start '>
                <Link href='/menu' className='py-3 flex items-center gap-2 text-gray-100 p-4 md:px-12 md:text-xl border-none bg-orange-500 rounded-md hover:border-none hover:ring-2 hover:bg-transparent hover:text-gray-900 transition-all'>Buy Now  <FaArrowRight />
                </Link>
                <Link href='/menu' className='flex items-center gap-2 py-3 p-4 md:px-12 borde-2 rounded-md hover:bg-orange-500 hover:text-gray-100 transition-all ring-2'>
