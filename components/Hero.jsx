  ...
  return (
    <div className='flex p-2  min-h-full flex-col-reverse md:gap-4 md:flex-row items-center justify-between'>
        <div className='flex flex-2 flex-col gap-8 text-center md:text-left'>
            <h1 className=' text-5xl md:leading-[4rem] font-bold '>Your One-Stop Shop for <br /> <span className='text-orange-600 italic'>Delicious Food</span></h1>
            <p className='md:-mt-6 font-xs'>Food Frenzy is your ultimate food ordering app, designed to fuel your culinary passions. Explore diverse cuisines, discover trending dishes, and order from a vast network of restaurants. Let Food Frenzy be your companion on a journey of gastronomic exploration.</p>
        ...
        <div className='text-center flex-3 relative -z-1 w-[400px] h-[200px] md:w-[2000px] md:h-[600px] grow'>
